    ...
    _distanceOfTimeInWords(date, compare_to) {
        ...
        if (this.props.precision == 1) {
            ...
            if (seconds > YEAR) {
                ...
                when.push(`${distance} ${plural('năm', distance)}`);
            ...
            if (seconds > MONTH) {
                ...
                when.push(`${distance} ${plural('tháng', distance)}`);
            ...
            if (seconds > DAY) {
                ...
                when.push(`${distance} ${plural('ngày', distance)}`);
            ...
            if (seconds > HOUR) {
                ...
                when.push(`${distance} ${plural('giờ', distance)}`);
            ...
            if (seconds > MINUTE) {
                ...
                when.push(`${distance} ${plural('phút', distance)}`);
                seconds -= distance * MINUTE;
            }

            if (seconds > 0) {
                when.push(`${seconds} ${plural('giây', seconds)}`);
            }
